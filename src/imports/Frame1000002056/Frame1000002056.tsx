import svgPaths from "./svg-l0yhg67jl2";
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] relative size-full">
          <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1f1d25] text-[14px] text-ellipsis tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.57] overflow-hidden text-ellipsis">Dimension</p>
          </div>
        </div>
      </div>
    </div>
...
function LabelContainer5() {
  return (
    <div className="content-stretch flex gap-[2px] items-center px-[4px] relative shrink-0" data-name="Label Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] tracking-[0.15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[12px]">Aspect Ratio</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex items-center overflow-clip py-[6px] relative shrink-0 w-full" data-name="Container">
      <MinHeight3 />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1f1d25] text-[12px] tracking-[0.17px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.43]">All</p>
      </div>
      <MinWidth2 />
      <div className="-translate-y-1/2 absolute overflow-clip right-0 size-[24px] top-1/2" data-name="chevron-down-small">
        <div className="absolute inset-[12.5%_30.87%_12.5%_30.88%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.18 18">
            <path d={svgPaths.p1cb35600} fill="var(--fill-0, #111014)" fillOpacity="0.56" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function LabelContainer6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[4px] px-[4px] relative shrink-0" data-name="Label Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] text-left tracking-[0.15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[12px]">Dimension</p>
      </div>
    </div>
  );
}
            ...
            <div className="absolute inset-[11.46%_19.79%]" data-name="vector">
              <div className="absolute inset-[-4.05%_-5.17%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 20">
                  <path d={svgPaths.p7ab6e80} id="vector" stroke="var(--stroke-0, #111014)" strokeLinejoin="round" strokeOpacity="0.56" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          </div>
...
function Container9() {
  return (
    <div className="content-stretch flex items-center overflow-clip py-[6px] relative shrink-0 w-full" data-name="Container">
      <MinHeight4 />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1f1d25] text-[12px] tracking-[0.17px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.43]">1920</p>
      </div>
      <MinWidth3 />
    </div>
  );
...
function Container10() {
  return (
    <div className="content-stretch flex items-center overflow-clip py-[6px] relative shrink-0 w-full" data-name="Container">
      <MinHeight5 />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1f1d25] text-[12px] tracking-[0.17px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.43]">1080</p>
      </div>
      <MinWidth4 />
    </div>
  );
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[4px]" data-name="Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] relative size-full">
          <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1f1d25] text-[14px] text-ellipsis tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.57] overflow-hidden text-ellipsis">Duration</p>
          </div>
        </div>
      </div>
    </div>
...
function LabelContainer7() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[4px] px-[4px] relative shrink-0" data-name="Label Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] text-left tracking-[0.15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[12px]">Duration Type</p>
      </div>
    </div>
  );
}
...
function LabelContainer8() {
  return (
    <div className="content-stretch flex gap-[2px] items-center px-[4px] relative shrink-0" data-name="Label Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] tracking-[0.15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[12px]">Duration</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="content-stretch flex items-center overflow-clip py-[6px] relative shrink-0 w-full" data-name="Container">
      <MinHeight6 />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1f1d25] text-[12px] tracking-[0.17px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.43]">00:10.999</p>
      </div>
      <MinWidth5 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="<Select>">
        <LabelContainer8 />
        <Input12 />
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="<FormHelperText>">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] tracking-[0.4px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.24]">Format: mm:ss.SSS</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame21() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full">
      <button className="content-stretch cursor-pointer flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Autocomplete 2.0">
        <Autocomplete3 />
      </button>
      <Frame18 />
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[4px]" data-name="Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] relative size-full">
          <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1f1d25] text-[14px] text-ellipsis tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.57] overflow-hidden text-ellipsis">Frame System</p>
          </div>
        </div>
      </div>
    </div>
...
function LabelContainer9() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[4px] px-[4px] relative shrink-0" data-name="Label Container">
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] text-left tracking-[0.15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[12px]">Frames</p>
      </div>
    </div>
  );
}
...
function Select4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="<Select>">
      ...
      <Input13 />
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="<FormHelperText>">
        <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#686576] text-[12px] text-left tracking-[0.4px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[1.66]">00:10:999 (mm:ss.SSS) = 240 frames @ 24fps</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[4px]" data-name="Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] relative size-full">
          <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1f1d25] text-[14px] text-ellipsis tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[1.57] overflow-hidden text-ellipsis">Advanced</p>
          </div>
        </div>
      </div>
    </div>
...
function Padding2() {
  return (
    <div className="content-stretch flex gap-[10px] items-start p-[9px] relative rounded-[100px] shrink-0" data-name="Padding">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white left-1/2 size-[16px] top-1/2" />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="_hidden">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
            <path d={svgPaths.pae529f2} fill="var(--fill-0, #6356E1)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[12px] relative size-full">
        <TItle3 />
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="<FormGroup> | <Checkbox>">
          <div className="content-stretch flex items-center relative shrink-0" data-name="<FormControlLabel> | Checkbox">
    ...
    <div className="relative size-full">
      <div className="absolute content-stretch flex flex-col gap-[12px] isolate items-start left-0 pb-[4px] pt-[8px] top-0 w-[248px]" data-name="Settings 2.0">
        ...
        <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[248px] z-[1]" data-name="Template Format">
          ...
          <RadioGroup />
          <Frame5 />
          <div className="content-stretch flex flex-col gap-[12px] items-start p-[12px] relative rounded-[12px] shrink-0 w-[248px]" data-name="Duration Type">
            <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.12)] border-solid inset-0 pointer-events-none rounded-[12px]" />
            <TItle1 />
            <Frame21 />
          </div>
